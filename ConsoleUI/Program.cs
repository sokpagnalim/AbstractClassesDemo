    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
             ...
             */
            var toyota= new Car() { HasTrunk = true, Year = "2020", Make= "Toyota", Model="Sienna" };
            var motorcycle=new Motorcycle() { HasSideCart = true, Year="2019", Make= "Honda", Model="Cube C215" };

            Vehicle van = new Car() { HasTrunk = false, Year = "2020", Make = "Honda", Model="Odyssy" };
            Vehicle truck = new Car() { HasTrunk = false, Year = "2019", Make = "Toyota", Model = "Pickup" };
